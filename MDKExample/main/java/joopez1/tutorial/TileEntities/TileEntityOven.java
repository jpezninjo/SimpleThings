package joopez1.tutorial.TileEntities;
...
public class TileEntityOven extends TileEntityFurnace {
	...
	public int getCookTime(ItemStack stack) {
		return (int) (super.getCookTime(stack) * 0.9);
	}
	...
	public static int getItemBurnTime(ItemStack p_145952_0_) {
		return (int) (1.1 * getItemBurnTimeHelper(p_145952_0_));
	}

	public static int getItemBurnTimeHelper(ItemStack p_145952_0_) {
		if (p_145952_0_ == null) {
			return 0;
		} else {
